...
def run_main_benchmark(
    ...
    incremental_data_path = os.path.join(cache_path, "experiments", run_start_str, analysis_type, "data")
    ...
    final_data_path = os.path.join(cache_path, "experiments", run_start_str, analysis_type, "data")
